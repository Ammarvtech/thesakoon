...
<tbody style="margin-top: 15px;">
  <tr class="">
<td class="">
<img alt="robot picture" class="" src="https://theskoon.com/images/Rectangle%209134.png" style="
width: 277px;
height: 101px;
">
</td>
...
<td class="" style="color:#444; font-weight: 400;"><br><br>
 ...
 <br>
    <br>
<span style="font-weight:bold;">Service Name: &nbsp;</span><span style="font-weight:lighter;" class="">{{$service_name}}</span> 
 <br>
  <span style="font-weight:bold;">Service Price: &nbsp;</span><span style="font-weight:lighter;" class="">{{$service_price}}</span>
<br>
<br>
@if($added_by)
<span style="font-weight:bold;">Service Added By: &nbsp;</span><span style="font-weight:lighter;" class="">{{$added_by}}</span>
@endif
<br>
<br>  
<br></td>
